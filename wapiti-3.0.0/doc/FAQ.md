...
Installing the libxml2 dependency should be the hard part but you can also use html5lib as an alternative (see INSTALL.md)
...
Yes I can help you understanding how Wapiti works and what are the files ivolved.
...
Yes, most of the payloads are stored in .txt files. You just have to add your owns.
...
Broken webpages, malformed links, mixed standards for HTML/XML/XHTML, propietary technologies, network or protocol issues...  
